        ...
        <div class="col-12 col-md-10 p-2 p-md-4">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-2 p-md-3">
                    ...
                    <!-- 🔹 TÍTULO -->
                    <h4 class="mb-3 mb-md-4">Editar Categoría</h4>

                    <form action="/control_finanzas/index.php?action=categorias.update" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipo" class="form-select" required>
                                ...
                                <option value="egreso" <?= $categoria['tipo'] == 'egreso' ? 'selected' : '' ?>>
                                    🔴 Egreso
                                </option>
                            </select>
                        </div>
