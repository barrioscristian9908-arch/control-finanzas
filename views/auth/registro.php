...
<html lang="en">
  <head>
    ...
    <title>Registro - Control Finanzas</title>
  ...
  <body class="">
     ...
     <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <form action="/control_finanzas/index.php?action=auth.register" method="POST" class="border rounded-3 p-4 bg-white" style="width: 25rem;">
        ...
        <h2 class="mb-2">Registro</h2>
            ...
            <div class="mb-3">
                <a href="/control_finanzas/index.php?action=login">¿Ya tienes una cuenta?</a>
            </div>
        </form>
    </div>
