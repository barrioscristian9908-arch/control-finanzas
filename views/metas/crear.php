        ...
        <div class="col-12 col-md-10 p-2 p-md-4">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-2 p-md-3">
                    ...
                    <!-- 🔹 TÍTULO -->
                    <h4 class="mb-3 mb-md-4">Nueva Meta</h4>

                    <form action="/control_finanzas/index.php?action=metas.store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="monto_objetivo" class="form-control" step="0.01" required>
                            </div>
                        </div>
